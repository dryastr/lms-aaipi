  ...
  $('body').on('click', '#webinarDemoVideoBtn', function (e) {
    ...
    var _makeVideoPlayerHtml = makeVideoPlayerHtml(path, source, height, videoTagId),
        ...
        '<div class="d-flex justify-content-between align-items-center">' +
          '<h3 class="section-title after-line font-20 text-dark-blue d-flex justify-content-between" style="height: 0.section-title.after-line:after">' +
          webinarDemoLang +
          '</h3>' + 
          '<div class="close-btn" aria-label="Close" style="cursor:pointer!important; padding: 5px; font-size: 40px"; font-weight: bold;">\n' +
