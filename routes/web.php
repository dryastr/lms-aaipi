...
Route::group(['namespace' => 'Auth', 'middleware' => ['check_mobile_app', 'share', 'check_maintenance']], function () {
    ...
    Route::get('/landing/{token}', 'LandingController@index');
});

Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_autologout']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::get('{slug}/share-count', 'WebinarController@shareCount');
    ...
    Route::get('/resources', 'ResourscesController@index')->name('resources.index');

    Route::group(['prefix' => 'resources'], function () {
        Route::get('/{title}', 'ResourcesDetailControler@resource');
        // Route::get('/download-pdf', 'ResourcesDetailControler@download')->name('download.pdf');
        Route::get('/download-pdf/{resourceId}', 'ResourcesDetailControler@download')->name('download.pdf')->middleware('web.auth');
    });
    ...
    Route::group(['prefix' => 'blog'], function () {
        ...
        Route::post('/{slug}/share/facebook', 'BlogController@shareFacebook')->name('blog.share.facebook');
        Route::post('/{slug}/share/twitter', 'BlogController@shareTwitter')->name('blog.share.twitter');
        Route::post('/{slug}/share/linkedin', 'BlogController@shareLinkedin')->name('blog.share.linkedin');
    });

    Route::group(['prefix' => 'contact'], function () {
        Route::get('/', 'ContactController@index');
        Route::post('/store', 'ContactController@store');
        Route::get('/terms-conditions', 'ContactController@conditionsContact');
    });
    ...
    Route::group(['prefix' => 'upcoming_courses'], function () {
        ...
        Route::get('{slug}/share-count', 'UpcomingCoursesController@shareCount');
    });
