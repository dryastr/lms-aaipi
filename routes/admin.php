...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web',  'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::get('/geojson', 'DashboardController@getPropinsiGeoJSON');
        Route::get('/getPropinsiGeoJSON', 'DashboardController@getPropinsiGeoJSON');
        Route::get('/getKabkotaGeoJSON/{provinceCode}', 'DashboardController@getKabkotaGeoJSON');
        Route::get('/get-user-data', 'DashboardController@getUserData');
        ...
        Route::group(['prefix' => 'dpw'], function () {
            Route::get('/', 'UserController@roleDpw');
        });

        Route::group(['prefix' => 'kehormatan'], function () {
            Route::get('/', 'UserController@kehormatan');
        });

        Route::group(['prefix' => 'dpn'], function () {
            Route::get('/', 'UserController@dpn');
        });

        // Route::group(['prefix' => 'dpw'], function () {
        //     Route::get('/', 'UserController@dpw');
        // });

        Route::group(['prefix' => 'biasa'], function () {
            Route::get('/', 'UserController@biasa');
        });
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::post('get-cities-by-province', 'UserController@getCitiesByProvince')->name('get-cities-by-province');
        ...
        Route::group(['prefix' => 'cross-competency'], function () {
            Route::get('/', 'CrossCompetencyController@index');
            Route::get('/create', 'CrossCompetencyController@create');
            Route::post('/store', 'CrossCompetencyController@store');
            Route::get('/{id}/edit', 'CrossCompetencyController@edit');
            Route::post('/{id}/update', 'CrossCompetencyController@update');
            Route::get('/{id}/delete', 'CrossCompetencyController@destroy');
        });
        ...
        Route::group(['prefix' => 'tematik'], function () {
            Route::get('/', 'TematikController@index');
            Route::get('/create', 'TematikController@create');
            Route::post('/store', 'TematikController@store')->name('tematik.store');
            Route::get('/{id}/edit', 'TematikController@edit');
            Route::post('/{id}/update', 'TematikController@update');
            Route::get('/{id}/delete', 'TematikController@destroy');
        });
        ...
        Route::group(['prefix' => 'type'], function () {
            ...
            Route::get('/{id}/delete', 'TypeController@destroy');
        });
        Route::group(['prefix' => 'provinsi'], function () {
            Route::get('/', 'RefProvinceConrtoller@index');
            Route::get('/create', 'RefProvinceConrtoller@create');
            Route::post('/store', 'RefProvinceConrtoller@store');
            Route::get('/{id}/edit', 'RefProvinceConrtoller@edit');
            Route::post('/{id}/update', 'RefProvinceConrtoller@update');
            Route::get('/{id}/delete', 'RefProvinceConrtoller@destroy');
        });
        Route::group(['prefix' => 'kabupaten'], function () {
            Route::get('/', 'RefCityController@index');
            Route::get('/create', 'RefCityController@create');
            Route::post('/store', 'RefCityController@store');
            Route::get('/{id}/edit', 'RefCityController@edit');
            Route::post('/{id}/update', 'RefCityController@update');
            Route::get('/{id}/delete', 'RefCityController@destroy');
        });
        ...
        Route::group(['prefix' => 'terms-condition'], function () {
            ...
            Route::get('/show', 'TermsConditionController@show');
            Route::post('/store', 'TermsConditionController@store');
            Route::get('/{id}/edit', 'TermsConditionController@edit');
            Route::post('/{id}/update', 'TermsConditionController@update');
            Route::get('/{id}/delete', 'TermsConditionController@destroy');
        });
        ...
        Route::group(['prefix' => 'ad-banners'], function () {
            Route::get('/', 'IklanBannerController@index');
            Route::get('/create', 'IklanBannerController@create');
            Route::post('/store', 'IklanBannerController@store');
            Route::get('/{id}/edit', 'IklanBannerController@edit');
            Route::post('/{id}/update', 'IklanBannerController@update');
            Route::get('/{id}/delete', 'IklanBannerController@destroy');
            // Route::delete('/{id}/delete', 'IklanBannerController@destroy')->middleware('csrf');
        });
        ...
        Route::group(['prefix' => 'resources'], function () {
            ...
            Route::post('/store', 'ResourcesController@store');
            Route::get('/{id}/edit', 'ResourcesController@edit');
            Route::post('/{id}/update', 'ResourcesController@update');
            Route::get('/{id}/delete', 'ResourcesController@destroy');
            Route::get('/{id}/approve', 'ResourcesController@approve');
            Route::get('/{id}/reject', 'ResourcesController@reject');
            Route::get('/{id}/unpublish', 'ResourcesController@unpublish');
            Route::get('/{id}/students', 'ResourcesController@studentsLists');
            Route::get('/{id}/sendNotification', 'ResourcesController@notificationToStudents');
            Route::post('/{id}/sendNotification', 'ResourcesController@sendNotificationToStudents');
        });
