...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance', 'check_autologout']], function () {
    ...
    Route::group(['prefix' => 'webinars'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::get('/terms-conditions', 'WebinarController@conditions');
    ...
    Route::group(['prefix' => 'resources'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::get('/new', 'ResourcesController@create');
            ...
            Route::get('/{id}/export-students-list', 'ResourcesController@exportStudentsList');
            Route::get('/{id}/duplicate', 'ResourcesController@duplicate');

            Route::group(['prefix' => '{resource_id}/statistics'], function () {
                Route::get('/', 'ResourceStatisticController@index');
            });
        });
        Route::get('/daftar', 'ResourcesController@daftar');
    });
