...
class File extends Model implements TranslatableContract
{
    ...
    public static $accessibility = [
        'free', 'paid',
    ];

    public static $videoTypes = ['mp4', 'mkv', 'avi', 'mov', 'wmv', 'avchd', 'flv', 'f4v', 'swf', 'mpeg-2', 'webm', 'video'];

    public static $fileTypes = [
        'pdf', 'powerpoint', 'sound', 'video', 'image', 'archive', 'document', 'project',
    ];

    public static $fileSources = [
