...
class WebinarChapter extends Model implements TranslatableContract
{
    ...
    public static $chapterActive = 'active';

    public static $chapterInactive = 'inactive';

    public static $chapterTypes = ['file', 'session', 'text_lesson'];

    public static $chapterStatus = ['active', 'inactive'];
