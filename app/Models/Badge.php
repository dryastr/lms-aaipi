...
class Badge extends Model implements TranslatableContract
{
    ...
    public static $badgeTypes = ['register_date', 'course_count', 'course_rate', 'sale_count', 'support_rate',
    ...
    public static function getUserBadges($user, $customBadges = false, $getNext = false)
    {
        $earnedBadges = [];
    ...
    public static function handleCondition($badges, $entry)
    {
        $result = null;
        $earnedBadges = [];
        $nextBadge = [];
    ...
    public static function handleBadgeReward($badge, $userId)
    {
