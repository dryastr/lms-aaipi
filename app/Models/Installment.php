...
class Installment extends Model implements TranslatableContract
{
    ...
    public static $optionsExplodeKey = '8888';

    // Enums
    public static $targetTypes = ['all', 'courses', 'store_products', 'bundles', 'meetings', 'registration_packages', 'subscription_packages'];

    public static $courseTargets = ['all_courses', 'live_classes', 'video_courses', 'text_courses', 'specific_categories', 'specific_instructors', 'specific_courses'];

    public static $productTargets = ['all_products', 'virtual_products', 'physical_products', 'specific_categories', 'specific_sellers', 'specific_products'];

    public static $bundleTargets = ['all_bundles', 'specific_categories', 'specific_instructors', 'specific_bundles'];

    public static $meetingTargets = ['all_meetings', 'specific_instructors'];

    public static $subscriptionTargets = ['all_packages', 'specific_packages'];

    public static $registrationPackagesTargets = ['all_packages', 'specific_packages'];
