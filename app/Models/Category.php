...
class Category extends Model implements TranslatableContract
{
    ...
    public function filtersTranslations()
    {
        return $this->hasMany('App/Models/Translation/FilterTranslation', 'filter_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\Resources', 'category_id', 'id');
    }
