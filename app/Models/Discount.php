...
class Discount extends Model
{
    ...
    public static $discountUserTypes = ['all_users', 'special_users'];

    public static $discountSource = ['all', 'course', 'bundle', 'category', 'meeting', 'product'];

    public static $discountSourceAll = 'all';

    public static $discountSourceCourse = 'course';

    public static $discountSourceCategory = 'category';

    public static $discountSourceMeeting = 'meeting';

    public static $discountSourceProduct = 'product';

    public static $discountSourceBundle = 'bundle';

    public static $discountTypes = ['percentage', 'fixed_amount'];

    public static $discountTypePercentage = 'percentage';

    public static $discountTypeFixedAmount = 'fixed_amount';
