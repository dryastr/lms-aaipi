...
class Webinar extends Model
{
    ...
    public function getBriefAttribute()
    {
        ...
        return [
            ...
            'discount_amount' => ((int) nicePriceWithTax($this->price)['price']
    ...
    public function checkCourseForSale($user = null)
    {
        $course = $this;
        $user = ($user) ?: apiAuth();
        ...
        if ($this->notPassedRequiredPrerequisite()) {
    ...
    public function checkCourseForSaleMsg($user = null)
    {
