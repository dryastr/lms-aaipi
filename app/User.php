...
class User extends Authenticatable
{
    ...
    public function isDpn(){
        return $this->role_name === Role::$dpn;
    }

    public function isDpw(){
        return $this->role_name === Role::$dpw;
    }
    ...
    {
        return $this->hasMany('App\Models\Resources', 'user_id', 'id')
