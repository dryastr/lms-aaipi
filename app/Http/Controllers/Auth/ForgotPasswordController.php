    ...
    public function forgot(Request $request)
    {
        ...
        if ($type == 'mobile') {
            ...
            if (!empty($user)) {
                ...
                return back()->with(['success_message' => trans('update.the_new_password_has_been_sent_to_your_number')]);
            }
            ...
            return back()->with(['success_message' => trans('auth.send_email_for_reset_password')]);
        }
    }
