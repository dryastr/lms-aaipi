...
class WebinarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'is_live_streaming' => 'nullable',
            'live_streaming_url' => 'nullable|string',
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($currentStep == 3) {
            ...
            $data['price_guest'] = ! empty($data['price_guest']) ? abs(convertPriceToDefaultCurrency($data['price_guest'])) : null;
    ...
    public function conditions()
    {
        ...
        return view('web.default.panel.webinar.tems.step_terms-conditions', compact('contents'));
    }
}
