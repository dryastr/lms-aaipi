...
class CertificateController extends Controller
{
    ...
    public function CertificatesTemplateStore(Request $request, $template_id = null)
    {
        ...
        if (! empty($template_id)) {
            ...
            $template->update([
                ...
                'name_komite' => $data['name_komite'],
                'nip_komite' => $data['nip_komite'],
                'tanda_tangan_komite' => $data['tanda_tangan_komite'],
                'is_komite' => ! empty($data['is_komite']) ? true : false,
                'updated_at' => time(),
            ]);
        } else {
    ...
    public function CertificatesDownload($id)
    {
        ...
        } elseif ($certificate->type == 'course') {
