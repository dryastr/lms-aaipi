                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ getAdminPanelUrl() }}/certificates/{{ $certificate->id }}/download" target="_blank" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" title="{{ trans('quiz.download_certificate') }}">
