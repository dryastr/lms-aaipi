                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_certificate_template_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/certificates/templates/{{ $template->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
