                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ getAdminPanelUrl() }}/bundles/{{ !empty($bundle) ? $bundle->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('update.required_points') }} (opsional)</label>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('update.bundle_url') }}<span class="text-danger">*</span></label>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($tickets as $ticket)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-ticket-id="{{ $ticket->id }}" data-webinar-id="{{ !empty($bundle) ? $bundle->id : '' }}" class="edit-ticket btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                            ...
                                                            @foreach($bundleWebinars as $bundleWebinar)
                                                                @if(!empty($bundleWebinar->webinar->title))
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" data-item-id="{{ $bundleWebinar->id }}" data-bundle-id="{{ !empty($bundle) ? $bundle->id : '' }}" class="edit-bundle-webinar btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($faqs as $faq)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <button type="button" data-faq-id="{{ $faq->id }}" data-webinar-id="{{ !empty($bundle) ? $bundle->id : '' }}" class="edit-faq btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-primary">{{ !empty($bundle) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>
