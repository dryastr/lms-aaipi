                        ...
                        <table class="table table-striped text-center font-14">
                            ...
                            @foreach($webinarExtraDescriptionValues as $extraDescription)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button type="button" data-item-id="{{ $extraDescription->id }}" data-webinar-id="{{ !empty($upcomingCourse) ? $upcomingCourse->id : '' }}" class="edit-extraDescription btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
