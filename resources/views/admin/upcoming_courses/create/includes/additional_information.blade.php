<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group mt-3">
            <label class="input-label">{{ trans('update.estimated_publish_date') }}<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            ...
            <input type="number" name="price" value="{{ (!empty($upcomingCourse) and !empty($upcomingCourse->price)) ? convertPriceToUserCurrency($upcomingCourse->price) : old('price') }}" class="form-control @error('price')  is-invalid @enderror"/>
            @error('price')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
