                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ getAdminPanelUrl('/upcoming_courses/'. (!empty($upcomingCourse) ? $upcomingCourse->id.'/update' : 'store')) }}" id="upcomingCourseForm" class="webinar-form">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-primary">{{ !empty($upcomingCourse) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>
