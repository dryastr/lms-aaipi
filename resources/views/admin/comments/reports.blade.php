                                    ...
                                    @foreach($reports as $report)
                                        <tr>
                                            ...
                                            <td width="150px">
                                                ...
                                                <a href="{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ $report->comment_id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.show') }}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
