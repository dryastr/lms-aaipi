                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('admin_comments_status')
                                                            <a href="{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ $reply->id }}/toggle" class="btn-transparent  text-primary text-d-none">
                                                        ...
                                                        @can('admin_comments_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ $reply->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
