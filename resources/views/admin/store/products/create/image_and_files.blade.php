                                ...
                                @foreach($product->files as $file)
                                    <tr>
                                        ...
                                        <td width="160" class="text-right">
                                            <button type="button" data-file-id="{{ $file->id }}" data-product-id="{{ !empty($product) ? $product->id : '' }}" class="edit-file btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
