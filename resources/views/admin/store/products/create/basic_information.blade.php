    ...
    <div class="row">
        <div class="col-12 col-md-5">
            ...
            <div class="form-group mt-15 ">
                <label class="input-label d-block">{{ trans('update.select_a_creator') }}<span class="text-danger">*</span> </label>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('public.summary') }}<span class="text-danger">*</span> </label>
