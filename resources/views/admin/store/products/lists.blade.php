                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    @foreach($products as $product)
                                        <tr class="text-center">
                                            ...
                                            <td class="font-12">{{ \Carbon\Carbon::parse($product->updated_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>

                                            {{-- <td class="font-12">{{ dateTimeFormat($product->created_at, 'Y M j | H:i') }}</td> --}}
                                            <td class="font-12">{{ \Carbon\Carbon::parse($product->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
