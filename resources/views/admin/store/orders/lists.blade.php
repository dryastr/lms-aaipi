                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Cari" name="item_title" value="{{ request()->get('item_title') }}">
                                </div>
                            </div>
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($order->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                                ...
                                                @if($order->status == \App\Models\ProductOrder::$waitingDelivery)
                                                    @can('admin_store_products_orders_tracking_code')
                                                        <button type="button"
                                                                ...
                                                                class="js-enter-tracking-code btn-transparent  text-primary text-d-none">
                                                            <i class="fa fa-map"></i>
                                                        </button>
                                                    @endcan
                                                @endif
