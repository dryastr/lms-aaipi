                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="{{ getAdminPanelUrl() }}/store/settings" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('update.virtual_product_commission') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('update.physical_product_commission') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('update.shipping_tracking_url') }}<span class="text-danger">*</span></label>
