                                ...
                                <table class="table table-striped font-14 text-center">
                                    ...
                                    @foreach($discounts as $discount)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($discount->start_date)->locale('id')->translatedFormat('j F Y | H:i') }}</td>

                                            {{-- <td>{{  dateTimeFormat($discount->end_date, 'Y/m/d h:i:s') }}</td> --}}
                                            <td>{{ \Carbon\Carbon::parse($discount->end_date)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            ...
                                            <td>
                                                @can('admin_store_discounts_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/store/discounts/{{ $discount->id }}/edit" class="btn-transparent  text-primary text-d-none btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
