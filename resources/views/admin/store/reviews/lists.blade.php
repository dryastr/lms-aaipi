                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Cari" name="search" placeholder="" value="{{ request()->get('search') }}">
                                </div>
                            </div>
                    ...
                    <table class="table table-striped font-14" id="datatable-details">
                        ...
                        @foreach($reviews as $review)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($review->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                ...
                                <td class="d-flex align-items-center justify-content-center">
                                    <div class="">
                                        @can('admin_store_products_reviews_status_toggle')
                                            <a href="{{ getAdminPanelUrl() }}/store/reviews/{{ $review->id }}/toggleStatus" class="btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ ($review->status == 'active') ? 'Hidden' : 'Publish' }}">
                                                @if($review->status == 'active')
                                    ...
                                    <div class="">
                                        @can('admin_store_products_reviews_detail_show')
                                            ...
                                            <button type="button" class="js-show-product-review-details btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="Rate Detail">
                                    ...
                                    <div class="">
                                        @can('admin_reviews_reply')
                                            <a href="{{ getAdminPanelUrl("/store/reviews/{$review->id}/reply") }}" target="_blank" class="btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.reply') }}">
