...
@section('content')
    <section class="section">
        <div class="section-header">
            {{-- <p>{{ dd('admin/main.404_page_setting') }}</p> --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.error_404_image') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.error_404_title') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.error_404_description') }}<span class="text-danger">*</span></label>
