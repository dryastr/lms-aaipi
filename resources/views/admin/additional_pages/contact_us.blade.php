                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.contact_us_background') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.map_position') }}<span class="text-danger">*</span></label>
                                            <div class="row">
                                                <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.map_zoom') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.contact_us_phones') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.contact_us_emails') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('admin/main.contact_us_address') }}<span class="text-danger">*</span></label>
