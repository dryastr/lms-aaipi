...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($group) ?trans('/admin/main.edit'): trans('admin/main.new') }} {{ trans('admin/main.provinsi') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}">{{ trans('admin/main.dashboard') }}</a>
                </div>
                <div class="breadcrumb-item active">
                    <a href="{{ getAdminPanelUrl() }}/categories">{{ trans('admin/main.provinsi') }}</a>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ getAdminPanelUrl() }}/provinsi/{{ !empty($group) ? $group->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('public.provinsi') }}
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="province_name" id="province_name" value="{{ old('province_name', !empty($group) ? $group->propinsi_name : '') }}" class="form-control @error('province_name')  is-invalid @enderror" placeholder="" />
                                    @error('province_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group mt-15">
                                    ...
                                    <input type="number" name="code" id="code" value="{{ old('code', !empty($group) ? $group->province_code : '') }}" class="form-control @error('code')  is-invalid @enderror" placeholder="" />
                                    @error('code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('public.shape') }}</label>
                                    <span class="text-danger">*</span>
