                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ getAdminPanelUrl() }}/advertising/banners/{{ !empty($banner) ? $banner->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="form-group">
                                    <label>{{ trans('admin/main.position') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('admin/main.banner_size') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('admin/main.link') }}<span class="text-danger">*</span></label>
