                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_advertising_banners_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/advertising/banners/{{ $banner->id }}/edit" class="btn-sm btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
