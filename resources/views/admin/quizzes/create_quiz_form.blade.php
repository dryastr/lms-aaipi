        ...
        <div class="row">
            <div class="col-12">
                ...
                @if(empty($selectedWebinar))
                    ...
                    @else
                        <div class="form-group">
                            <label class="input-label d-block">{{ trans('admin/main.webinar') }}<span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('quiz.quiz_title') }}<span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('public.time') }} <span class="braces">({{ trans('public.minutes') }})</span>({{ trans('public.optional') }})</label>
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('quiz.number_of_attemps') }}({{ trans('public.optional') }})</label>
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('quiz.pass_mark') }}<span class="text-danger">*</span></label>
