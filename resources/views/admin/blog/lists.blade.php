                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($blog as $post)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($post->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            <td>
                                            ...
                                            <td width="150px">
                                                @can('admin_blog_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/blog/{{ $post->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
