                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @can('admin_edit_trending_categories')
                                                                    <a href="{{ getAdminPanelUrl() }}/blog/categories/{{ $category->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
