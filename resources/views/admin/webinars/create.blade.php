                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ getAdminPanelUrl() }}/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block">{{ trans('panel.course_type') }}<span class="text-danger">*</span></label>

                                                <select id="WebinarType" name="type"  class="custom-select @error('type')  is-invalid @enderror">
                                            ...
                                            <div id="additionalForm" class="form-group custom-switches-stacked">
                                                <label class="" for="is_live_streaming">{{ trans('webinars.is_live_streaming') }}</label>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="is_live_streaming" class="custom-control-input" id="is_live_streaming" {{ !empty($webinar) && $webinar->is_live_streaming ? 'checked' : ''  }}>
                                                    <label class="custom-control-label" for="is_live_streaming"></label>
                                                </div>
                                            </div>

                                            <div id="additionalTable" class="form-group mt-15">
                                                <label class="input-label">{{ trans('webinars.live_streaming_url') }}</label>
                                                <input type="text" name="live_streaming_url" value="{{ !empty($webinar) ? $webinar->live_streaming_url : old('live_streaming_url') }}" class="form-control @error('live_streaming_url')  is-invalid @enderror" placeholder=""/>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('update.points') }}<span class="text-danger">*</span></label>
                                                <input type="number" name="points" value="{{ !empty($webinar) ? $webinar->points : old('points') }}" class="form-control @error('points')  is-invalid @enderror" placeholder=""/>
                                                @error('points')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('admin/main.class_url') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block">{{ trans('admin/main.select_a_instructor') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('public.seo_description') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('public.thumbnail_image') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <small class="text-muted mt-1">Hanya file PNG dan/atau JPG yang diperbolehkan.</small> 
                                            </div>
                                            ...
                                            <div class="form-group mt-0">
                                                <label class="input-label font-12">{{ trans('update.path') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            @if(getFeaturesSettings('timezone_in_create_webinar'))
                                                ...
                                                <div class="form-group">
                                                    <label class="input-label">{{ trans('update.timezone') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="price_guest" value="{{ (!empty($webinar) and !empty($webinar->price_guest)) ? convertPriceToUserCurrency($webinar->price_guest) : old('price_guest') }}" class="form-control @error('price_guest')  is-invalid @enderror" placeholder="{{ trans('public.0_for_free') }}"/>
                                                @error('price_guest')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            {{-- Price Member --}}
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('public.price_guest') }} ({{ $currency }})<span class="text-danger">*</span></label>
                                            ...
                                            @if(!empty($webinar) and $webinar->creator->isOrganization())
                                                <div class="form-group mt-15">
                                                    <label class="input-label">{{ trans('update.organization_price') }} ({{ $currency }})<span class="text-danger">*</span></label>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($tickets as $ticket)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-ticket-id="{{ $ticket->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-ticket btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                            ...
                                                            @foreach($prerequisites as $prerequisite)
                                                                @if(!empty($prerequisite->prerequisiteWebinar->title))
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" data-prerequisite-id="{{ $prerequisite->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-prerequisite btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($faqs as $faq)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <button type="button" data-faq-id="{{ $faq->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-faq btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                            ...
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                @foreach($webinarExtraDescriptionValues as $extraDescription)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <button type="button" data-item-id="{{ $extraDescription->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-extraDescription btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($webinarQuizzes as $webinarQuiz)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-webinar-quiz-id="{{ $webinarQuiz->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-webinar-quiz btn-transparent  text-primary text-d-none mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                ...
                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('admin/main.another_category') }}<span class="text-danger">*</span></label>

                                    <select id="othercategories" class="custom-select @error('other_category_id') is-invalid @enderror" name="other_category_id" required>
                                        <option {{ !empty($webinar) ? '' : 'selected' }} disabled>{{ trans('admin/main.choose_another_category') }}</option>

                                        @foreach($otherCategories as $otherCategory)
                                            <option value="{{ $otherCategory->id }}" {{ (!empty($webinar) and $webinar->other_category_id == $otherCategory->id) ? 'selected' : '' }}>{{ $otherCategory->types }}</option>
                                        @endforeach
                                    </select>

                                    @error('other_category_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                    @enderror
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-primary">{{ !empty($webinar) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>
...
{{-- <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script> --}}
    ...
    <script>
        ...
        $("#is_live_streaming").change(function () {
            if ($(this).is(":checked")) {
