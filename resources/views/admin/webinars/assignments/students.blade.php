                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    @can('admin_webinar_assignments_conversations')
                                        <a href="{{ getAdminPanelUrl() }}/assignments/{{ $assignment->id }}/history/{{ $history->id }}/conversations" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.conversations') }}">
