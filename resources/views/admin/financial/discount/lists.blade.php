                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($discounts as $discount)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($discount->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>

                                            {{-- <td>{{  dateTimeFormat($discount->expired_at, 'Y M d - H:i') }}</td> --}}
                                            <td>{{ \Carbon\Carbon::parse($discount->expired_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                <div class="mr-1">
                                                    @can('admin_discount_codes_edit')
                                                        <a href="{{ getAdminPanelUrl() }}/financial/discounts/{{ $discount->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
