                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="{{ getAdminPanelUrl() }}/financial/discounts/{{ !empty($discount) ? $discount->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="form-group js-courses-input {{ (empty($discount) or $discount->source != \App\Models\Discount::$discountSourceCourse) ? 'd-none' : '' }}">
                                    <label class="input-label">{{ trans('admin/main.courses') }}<span class="text-danger">*</span></label>
                                        ...
                                        @if(!empty($discount) and !empty($discount->discountCourses))
                                            @foreach($discount->discountCourses as $discountCourse)
                                                @if(!empty($discountCourse->course))
                                                    <option value="{{ $discountCourse->course->id }}" selected>{{ $discountCourse->course->slug }}</option>
                                                @endif
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group js-bundles-input {{ (!empty($discount) and $discount->source == \App\Models\Discount::$discountSourceBundle) ? '' : 'd-none' }}">
                                    <label class="input-label">{{ trans('update.bundles') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group js-categories-input {{ (empty($discount) or $discount->source != \App\Models\Discount::$discountSourceCategory) ? 'd-none' : '' }}">
                                    <label class="input-label">{{ trans('admin/main.categories') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group js-products-input {{ (empty($discount) or $discount->source != \App\Models\Discount::$discountSourceProduct) ? 'd-none' : '' }}">
                                    <label class="input-label d-block">{{ trans('update.product_type') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('admin/main.users') }}<span>(Opsional)</span></label>
                                ...
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('admin/main.groups') }}<span>(Opsional)</span></label>
                                ...
                                <div class="form-group js-percentage-inputs {{ (!empty($discount) and $discount->discount_type == 'fixed_amount') ? 'd-none' : '' }}">
                                    <label>{{ trans('admin/main.discount_percentage') }}<span>(Opsional)</span></label>
                                ...
                                <div class="form-group js-percentage-inputs {{ (!empty($discount) and $discount->discount_type == 'fixed_amount') ? 'd-none' : '' }}">
                                    <label>{{ trans('admin/main.max_amount') }}<span>(Opsional)</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                ...
                                <div class="form-group js-fixed-amount-inputs {{ (empty($discount) or $discount->discount_type == 'percentage') ? 'd-none' : '' }}">
                                    <label>{{ trans('admin/main.amount') }}<span>(Opsional)</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <i class="fas fa-dollar-sign"></i>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('update.minimum_order') }}<span>(Opsional)</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <i class="fas fa-dollar-sign"></i>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('admin/main.usable_times') }}<span>(Opsional)</span></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{{ trans('admin/main.discount_code') }}<span class="text-danger">*</span></label>
