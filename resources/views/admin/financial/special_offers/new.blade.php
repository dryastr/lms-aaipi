                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="{{ getAdminPanelUrl() }}/financial/special_offers/{{ !empty($specialOffer) ? $specialOffer->id.'/update' : 'store' }}"
                                ...
                                <div class="js-course-field form-group {{ (empty($specialOffer) or !empty($specialOffer->webinar_id)) ? '' : 'd-none' }}">
                                    <label>{{ trans('admin/main.class') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="js-bundle-field form-group {{ (!empty($specialOffer) and !empty($specialOffer->bundle_id)) ? '' : 'd-none' }}">
                                    <label>{{ trans('update.bundle') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="js-subscribe-field form-group {{ (!empty($specialOffer) and !empty($specialOffer->subscribe_id)) ? '' : 'd-none' }}">
                                    <label>{{ trans('public.subscribe') }}(Opsional)</label>
                                ...
                                <div class="js-registration_package-field form-group {{ (!empty($specialOffer) and !empty($specialOffer->registration_package_id)) ? '' : 'd-none' }}">
                                    <label>{{ trans('update.registration_package') }}(Opsional)</label>
                                ...
                                <div class="form-group ">
                                    <label>{{ trans('admin/main.discount_percentage') }}<span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                               name="percent" class="spinner-input form-control   @error('percent') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('admin/main.from_date') }}(Opsional)</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="from_date" class="form-control  datetimepicker"
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('admin/main.to_date') }}(Opsional)</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="dateRangeLabel">
                                                <i class="fa fa-calendar"></i>
                                        ...
                                        <input type="text" name="to_date" class="form-control datetimepicker"
                                               aria-describedby="dateRangeLabel" autocomplete="off"
