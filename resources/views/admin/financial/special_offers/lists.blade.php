                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Cari" name="name" value="{{ request()->get('name') }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                ...
                                <table class="table table-striped font-14 text-center">
                                    ...
                                    @foreach($specialOffers as $specialOffer)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($specialOffer->from_date)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            
                                            <td>{{ \Carbon\Carbon::parse($specialOffer->to_date)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            ...
                                            <td>
                                                @can('admin_product_discount_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/financial/special_offers/{{ $specialOffer->id }}/edit" class="btn-transparent  text-primary text-d-none btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
