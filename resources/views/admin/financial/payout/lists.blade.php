                                    ...
                                    @if($payouts->count() > 0)
                                        @foreach($payouts as $payout)
                                            ...
                                            <tr>
                                                ...
                                                <td width="150px">
                                                    <div class="">
                                                        <button type="button" class="js-show-details btn-sm btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('update.show_details') }}">
                                                            <i class="fa fa-eye"></i>
                                                        </button>
