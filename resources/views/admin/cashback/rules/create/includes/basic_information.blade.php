<div class="row">
    <div class="col-12 col-md-5">
        ...
        <div class="form-group ">
            <label class="input-label">{{ trans('admin/main.users') }}(Opsional)</label>
        ...
        <div class="form-group ">
            <label class="input-label">{{ trans('admin/main.user_group') }}(Opsional)</label>
        ...
        <div class="form-group">
            <label class="input-label">{{ trans('admin/main.start_date') }}(Opsional)</label>
        ...
        <div class="form-group">
            <label class="input-label">{{ trans('admin/main.end_date') }}(Opsional)</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="dateRangeLabel">
                        <i class="fa fa-calendar"></i>
