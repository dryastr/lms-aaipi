<div class="row mt-15">
    <div class="col-12 col-md-4">
        <div class="form-group ">
            <label class="input-label">{{ trans('admin/main.amount') }}<span class="text-danger">*</span></label>
    ...
    <div class="col-12 col-md-4">
        <div class="form-group ">
            <label class="input-label">{{ trans('update.amount_type') }}(Opsional)</label>
...
<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group">
            <label class="input-label">{{ trans('admin/main.min_amount') }}(Opsional)</label>
