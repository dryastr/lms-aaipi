                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_cashback_rules')
                                                    <a href="{{ getAdminPanelUrl("/cashback/rules/{$rule->id}/edit") }}" class="btn-sm btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
