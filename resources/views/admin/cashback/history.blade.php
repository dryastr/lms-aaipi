                                            ...
                                            <td class="text-center mb-2" width="120">
                                                @if(!empty($transaction->user))
                                                    @can('admin_users_impersonate')
                                                        <a href="{{ getAdminPanelUrl() }}/users/{{ $transaction->user_id }}/impersonate" target="_blank" class="btn-transparent text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.login') }}">
                                                            <i class="fa fa-user-shield"></i>
                                                        </a>
                                                    @endcan

                                                    @can('admin_users_edit')
                                                        <a href="{{ getAdminPanelUrl() }}/users/{{ $transaction->user_id }}/edit" class="btn-transparent text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
