...
<head>
    ...
    <link rel="stylesheet" href="/assets/admin/css/booksmarks.css">
</head>
...
<div id="app">
    ...
    <section class="section d-flex flex-wrap align-items-stretch">
        <div class="col-lg-8 col-12 min-vh-100 order-lg-1 order-2 background-walk-y position-relative overlay-gradient-bottom" data-background="{{ $getPageBackgroundSettings['admin_login'] ?? '' }}">
        <div class="absolute-bottom-left index-2">
                <div class="text-light p-5 pb-2">
                    <div class="mb-2 pb-3">
                        <h1 class="mb-2 display-4 font-weight-bold">AAIPI LMS</h1>
                        <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
                    </div>
                    All rights reserved by AAIPI <br/>
                    Developed By <a class="text-light bb" target="_blank" href="https://qeraton.com">Qeraton</a>
                </div>
            </div>

        </div>

        <div class="col-lg-4 col-md-6 col-12 min-vh-100 order-lg-2 order-1 bg-white">
        @yield('content')
        </div>
    </section>
