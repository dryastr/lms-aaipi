                        ...
                        <table class="table table-striped text-center font-14">
                            ...
                            @foreach($regions as $region)
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($region->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>

                                    <td>
                                        @can('admin_regions_edit')
                                            <a href="{{ getAdminPanelUrl() }}/regions/{{ $region->id }}/edit" class="btn-transparent  text-primary text-d-none mr-2">
