            ...
            <section class="card">
                <div class="card-body">
                    <form action="{{ !empty($region) ? getAdminPanelUrl("/regions/{$region->id}/update") : getAdminPanelUrl("/regions/store") }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="input-label">{{ trans('admin/main.title') }}<span class="text-danger">*</span></label>
                        ...
                        <button type="submit" class="btn btn-primary mt-4">{{ trans('admin/main.save') }}</button>
                    </form>
                </div>
            </section>
        </div>
