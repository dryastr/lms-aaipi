...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($group) ?trans('/admin/main.edit'): trans('admin/main.new') }} {{ trans('admin/main.type') }}</h1>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ getAdminPanelUrl() }}/type/{{ !empty($group) ? $group->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
