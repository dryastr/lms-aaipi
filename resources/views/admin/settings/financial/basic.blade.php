            ...
            <form action="{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[commission]" value="{{ (!empty($itemValue) and !empty($itemValue['commission'])) ? $itemValue['commission'] : old('commission') }}" class="form-control" maxlength="3" min="0" max="100"/>
                    </div>
                ...
                <div class="form-group">
                    <label>{{ trans('admin/main.tax') }}<span class="text-danger">*</span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                        ...
                        <input type="number" name="value[tax]" value="{{ (!empty($itemValue) and !empty($itemValue['tax'])) ? $itemValue['tax'] : old('tax') }}" class="form-control" maxlength="3" min="0" max="100"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[minimum_payout]" value="{{ (!empty($itemValue) and !empty($itemValue['minimum_payout'])) ? $itemValue['minimum_payout'] : old('minimum_payout') }}" class="form-control" min="0"/>
                    </div>
