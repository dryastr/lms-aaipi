                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="d-flex align-items-center justify-content-end">
                                    <button type="button" data-path="{{ getAdminPanelUrl("/settings/financial/user_banks/{$userBank->id}/edit") }}" class="js-edit-user-banks font-14 btn-transparent  text-primary text-d-none">
