    ...
    <form action="{{ getAdminPanelUrl() }}/settings/maintenance_settings" method="post">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    <label class="input-label mb-0">{{ trans('admin/main.title') }}<span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label class="input-label mb-0">{{ trans('admin/main.image') }}<span class="text-danger">*</span></label>
                ...
                <div class="form-group ">
                    <label class="control-label">{{ trans('admin/main.description') }}<span class="text-danger">*</span></label>
