                    ...
                    <li data-id="{{ $statistic->id }}" class="row align-items-center mt-2">
                        ...
                        <div class="col-2 text-right">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <button type="button" class="js-edit-statistic btn-transparent  text-primary text-d-none mr-2" data-path="{{ getAdminPanelUrl("/settings/personalization/statistics/{$statistic->id}/editItem") }}"><i class="fa fa-edit"></i></button>
