    ...
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6">
            <form action="{{ getAdminPanelUrl() }}/settings/socials/store" method="post">
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('admin/main.icon') }}<span class="text-danger">*</span></label>
                ...
                @if(!empty($itemValue) and is_array($itemValue))
                    @foreach($itemValue as $key => $val)
                        <tr>
                            ...
                            <td>
                                <a href="{{ getAdminPanelUrl() }}/settings/socials/{{ $key }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
