                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->get('tab') == "redeem_point") active @endif" id="redeem_point-tab" href="{{ getAdminPanelUrl("/settings/financial?tab=redeem_point") }}">{{ trans('update.redeem') }}</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                @if(request()->get('tab') == "redeem_point")
                                @include('admin.settings.financial.redeem_point.index',['itemValue' => (!empty($settings) and !empty($settings['redeem_point'])) ? $settings['redeem_point']->value : ''])
                               @endif
                            </div>
