                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="url_member_area-tab" data-toggle="tab" href="#url_member_area" role="tab" aria-controls="url_member_area" aria-selected="true">{{ trans('update.options') }}</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                @include('admin.settings.general.url_member_area',['itemValue' => (!empty($settings) and !empty($settings['url_member_area'])) ? $settings['url_member_area']->value : ''])
                            </div>
