                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($testimonials as $testimonial)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($testimonial->created_at)->locale('id')->translatedFormat('j F Y | H:i') }}</td>
                                            <td width="150px">

                                                @can('admin_supports_reply')
                                                    <a href="{{ getAdminPanelUrl() }}/testimonials/{{ $testimonial->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
