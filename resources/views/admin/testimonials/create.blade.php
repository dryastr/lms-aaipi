                            ...
                            <form action="{{ getAdminPanelUrl() }}/testimonials/{{ !empty($testimonial) ? $testimonial->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('admin/main.user_name') }}<span class="text-danger">*</span></label>
                                            <input type="text" name="user_name" class="form-control  @error('user_name') is-invalid @enderror"
                                                   value="{{ !empty($testimonial) ? $testimonial->translations[0]->user_name : old('user_name') }}"/>
                                            @error('user_name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('admin/main.user_bio') }}<span class="text-danger">*</span></label>
                                            <input type="text" name="user_bio" class="form-control  @error('user_bio') is-invalid @enderror"
                                                   value="{{ !empty($testimonial) ? $testimonial->translations[0]->user_bio : old('user_bio') }}"/>
                                            @error('user_bio')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('admin/main.rate') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('admin/main.comment') }}<span class="text-danger">*</span></label>
                                    ...
                                    <textarea id="summernote" name="comment" class="summernote form-control @error('comment')  is-invalid @enderror">{!! !empty($testimonial) ? $testimonial->translations[0]->comment : old('comment')  !!}</textarea>
                                    @error('comment')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
