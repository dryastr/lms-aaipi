                                ...
                                <td class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex align-items-center justify-content-center">
                                        @can('admin_reviews_status_toggle')
                                            <a href="{{ getAdminPanelUrl() }}/reviews/{{ $review->id }}/toggleStatus" class="btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ ($review->status == 'active') ? 'Hidden' : 'Publish' }}">
                                                @if($review->status == 'active')
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        @can('admin_reviews_detail_show')
                                            ...
                                            <button type="button" class="js-show-review-details btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="Rate Detail">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        @can('admin_reviews_reply')
                                            <a href="{{ getAdminPanelUrl("/reviews/{$review->id}/reply") }}" target="_blank" class="btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.reply') }}">
