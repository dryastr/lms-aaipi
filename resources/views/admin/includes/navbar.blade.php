    ...
    <div class="d-flex align-items-center justify-content-between w-100">
        ...
        <div class="">
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown dropdown-list-toggle">
                    ...
                    <div class="dropdown-menu dropdown-list dropdown-menu-right">
                        <div class="dropdown-list-icons mb-0" height="150px">
                                <a href="https://qeraton.com" class="dropdown-item">
                                    <div class="dropdown-item-icon bg-info text-white d-flex align-items-center justify-content-center">
                                        <i class="fa fa-info"></i>
                                    </div>
                                    <div class="dropdown-item-desc">
                                        LMS AAIPI Version 1.0.0
                                        <div class="time text-primary">All rights reserved By AAIPI <br/> Developed By Qeraton</div>
                                    </div>
                                </a>
                        </div>
                    </div>
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user" style="color: #78828a!important;">
                        <img alt="image" src="{{ $authUser->getAvatar() }}" class="rounded-circle mr-1">
                        <div class="d-sm-none d-lg-inline-block" style="color: #78828a!important;">{{ $authUser->full_name }}</div>
                    </a>
