                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_group_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/users/groups/{{ $group->id }}/edit" class="btn-transparent  text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
