                                        ...
                                        <td>{{ $become->user->full_name }}</td>
                                            ...
                                            <td>
                                                ...
                                                @can('admin_users_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/users/{{ $become->user_id }}/edit?type=check_instructor_request" class="btn-transparent  text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.check') }}">
