                        ...
                        <tr>
                            ...
                            <td class="text-center mb-2" width="120">
                                @can('admin_users_impersonate')
                                    <a href="{{ getAdminPanelUrl() }}/users/{{ $user->id }}/impersonate" target="_blank" class="btn-transparent text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.login') }}">
                                ...
                                @can('admin_users_not_access_content_toggle')
                                    <a href="{{ getAdminPanelUrl() }}/users/not-access-to-content/{{ $user->id }}/active" class="btn-transparent text-primary text-d-none" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.active') }}">
    ...
    <div id="addUserToNotAccessModal" class="d-none">
        ...
        <div class="mt-25">
            <form action="{{ getAdminPanelUrl() }}/users/not-access-to-content/store" method="post">
                ...
                <div class="form-group">
                    <label class="input-label d-block">{{ trans('admin/main.user') }}<span class="text-danger">*</span></label>
