            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    <tr>
                        ...
                        <th>{{ trans('admin/main.is_member_aaipi') }}</th>
                    ...
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($user->is_member_aaipi > 0 && $user->is_member_aaipi < 2)
                                    <div class="success">
                            ...
                            <td class="d-flex align-items-center justify-content-center text-center mb-2" width="120">
                                @can('admin_users_impersonate')
                                    <a href="{{ getAdminPanelUrl() }}/users/{{ $user->id }}/impersonate" target="_blank" class="btn-transparent text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.login') }}">
                                        <i class="fa fa-user-shield"></i>
                                    </a>
                                @endcan

                                @can('admin_users_edit')
                                    <a href="{{ getAdminPanelUrl() }}/users/{{ $user->id }}/edit" class="btn-transparent text-primary text-d-none mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
