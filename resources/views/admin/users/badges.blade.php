                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <form action="{{ getAdminPanelUrl() }}/users/badges/store" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label class=" control-label">{{ trans('admin/main.condition') }}<span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group">
                                                            <label>{{ trans('update.score') }}({{ trans('public.optional') }})</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label>{{ trans('admin/main.description') }}<span class="text-danger">*</span></label>
