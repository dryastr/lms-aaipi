            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ getAdminPanelUrl() }}/{{ (!empty($isCourseNotice) and $isCourseNotice) ? 'course-noticeboards' : 'noticeboards' }}/{{ !empty($noticeboard) ? $noticeboard->id .'/update' : 'store' }}" class="form-horizontal form-bordered mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{!! trans('admin/main.title') !!}<span class="text-danger">*</span></label>
                                ...
                                @if(!empty($isCourseNotice) and $isCourseNotice)
                                    <div class="form-group">
                                        <label class="input-label control-label">{!! trans('product.course') !!}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label control-label">{!! trans('update.color') !!}<span class="text-danger">*</span></label>
                                ...
                                @else
                                    <div class="form-group">
                                        <label class="control-label">{!! trans('admin/main.type') !!}<span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="control-label">{{ trans('admin/main.message') }}<span class="text-danger">*</span></label>
