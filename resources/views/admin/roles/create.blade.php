                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input type="{{ !empty($role) ? 'hidden' : 'text' }}" name="name" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="caption" class="form-control @error('caption') is-invalid @enderror" value="{{ !empty($role) ? $role->caption : old('caption') }}"
