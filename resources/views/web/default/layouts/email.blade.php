...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
    <div class="container-email">
        ...
        <div style="background-color: black; margin-top: 0; padding:10px 0; border-radius: 10px; text-align:center">
            <p style="color:white; font-size: 10px;">&copy;2023, LMS</p>
        </div>
    </div>
</body>
