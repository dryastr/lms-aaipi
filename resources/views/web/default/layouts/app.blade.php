...
<head>
    ...
    <!-- Contact -->
    <link rel="stylesheet" href="../lang/sass/parts/_contact.scss">
    <link rel="stylesheet" href="/assets/default/css/custom-elms.css?v=1.0">
...
<script src="/assets/default/js/lozad.min.js"></script>
...
<script>
    $(function(){$(".lazyload").lazyload({
        placeholder:'{{asset("assets/admin/img/lazyload.svg")}}',
        effect:"fadeIn",
        threshold:"-50"
    })});
</script>
...
<script>
    var scroll = new SmoothScroll('a[href*="#"]', {
        speed: 800, // Kecepatan scrolling (ms)
        speedAsDuration: true, // Kecepatan dianggap sebagai durasi animasi
    });
