...
<form id="logout-form" action="{{ url('/logout') }}" method="POST" class="d-flex align-items-center w-100 px-15 py-10 text-danger font-14 bg-transparent">
    @csrf
    <img src="/assets/default/img/icons/user_menu/logout.svg" class="icons">
    <button type="submit" class="ml-5" style="border: none; background-color: transparent; cursor: pointer;">{{ trans('auth.logout') }}</button>
</form>
