...
@section('content')
    <section class="forum-hero-section mt-50 position-relative">
        ...
        <div class="forum-hero-section__image">
            <img src="/assets/default/img/forum/hero-forum.png" class="img-cover" alt="forum hero">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="/assets/default/img/forum/1-forum.svg" alt="{{ trans('update.forums') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="/assets/default/img/forum/2-forum.svg" alt="{{ trans('update.topics') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="/assets/default/img/forum/3-forum.svg" alt="{{ trans('site.posts') }}" class="forum-stat-icon"/>
                ...
                <div class="col-6 col-md-3">
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <img src="/assets/default/img/forum/4-forum.svg" alt="{{ trans('update.members') }}" class="forum-stat-icon"/>
