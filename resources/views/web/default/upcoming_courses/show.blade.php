...
@push('styles_top')
    ...
    <link rel="stylesheet" href="/assets/aaipi/css/web/default/upcoming_courses.css">
@endpush


@section('content')
    <section class="course-cover-container course-cover-container-custom bg-gray200">
                ...
                <div class="rounded-lg shadow-sm">
                    ...
                    <div class="px-20 pb-30">
                        ...
                        <div class="mt-40 p-10 rounded-sm border row align-items-center favorites-share-box">
                            ...
                            <div class="col">
                                <a href="#" class="js-share-course d-flex flex-column align-items-center text-gray" onclick="shareCount('{{ $upcomingCourse->slug }}')">
                                    <i data-feather="share-2" width="20" height="20"></i>
                                    <span class="font-12">{{ trans('public.share') }}</span>
                                    <span class="share-count" style="font-size: 15px">({{ $upcomingCourse->share_count }})</span>
                                </a>
                            </div>
                        </div>
...
@push('scripts_bottom')
    ...
    <script>
        function shareCount(slug) {
            $.ajax({
                url: '/upcoming_courses/' + slug + '/share-count',
                type: 'GET',
