...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
                <a href="/panel" class="user-name mt-15">
                    <h3 class="font-16 font-weight-bold text-center" style="word-wrap: break-word; width: 220px;">
                        {{ strlen($authUser->full_name) > 50 ? substr($authUser->full_name, 0, 50).'...' : $authUser->full_name }}    
                    </h3>
                </a>
        ...
        @if($authUser->is_member_aaipi)
            <div>
                <span class="badge badge-danger">Member AAIPI</span>
            </div>
        @endif
    </div>
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif @if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])) without-bottom-image @endif" @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        <li class="sidenav-item  accordion-row {{ (request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'sidenav-item-active' : '' }}">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#webinarCollapse" role="button" aria-expanded="false" aria-controls="webinarCollapse">
                ...
                <div class="d-flex justify-content-between" style="width: 100%;">
                    <div class="">
                        <span class="font-14 text-dark-blue font-weight-500">{{ trans('panel.learning') }}</span>
                    </div>
                    <div class="">
        ...
        @if($authUser->isOrganization() || $authUser->isTeacher())
        <li class="sidenav-item  accordion-row {{ (request()->is('panel/resources') or request()->is('panel/resources/*')) ? 'sidenav-item-active' : '' }}">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#ResourceCollapse" role="button" aria-expanded="false" aria-controls="ResourceCollapse">
                <span class="sidenav-item-icon mr-10">
                    @include('web.default.panel.includes.sidebar_icons.webinars')
                </span>
                <div class="d-flex justify-content-between" style="width: 100%;">
                    <div class="">
                        <span class="font-14 text-dark-blue font-weight-500">{{ trans('admin/main.resources') }}</span>
                    </div>
                    <div class="">
                        <i class="collapse-chevron-icon" data-feather="chevron-down" width="25" class="text-gray"></i>
                    </div>
            ...
            <div class="collapse {{ (request()->is('panel/resources') or request()->is('panel/resources/*')) ? 'show' : '' }}" id="ResourceCollapse">
                <ul class="sidenav-item-collapse">
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                        <li class="mt-5 {{ (request()->is('panel/resources/new')) ? 'active' : '' }}">
                            <a href="/panel/resources/new">{{ trans('public.new') }}</a>
                        </li>

                        <li class="mt-5 {{ (request()->is('panel/resources')) ? 'active' : '' }}">
                            <a href="/panel/resources">{{ trans('panel.my_resources') }}</a>
                        </li>
                    @endif
                </ul>
            </div>
        ...
        <li class="sidenav-item  accordion-row {{ (request()->is('panel/resources') or request()->is('panel/resources/*')) ? 'sidenav-item-active' : '' }}">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#ResourceCollapse" role="button" aria-expanded="false" aria-controls="ResourceCollapse">
                ...
                <div class="d-flex justify-content-between" style="width: 100%;">
                    <div class="">
                        <span class="font-14 text-dark-blue font-weight-500">{{ trans('admin/main.my_resources') }}</span>
                    </div>
                    <div class="">
                        <i class="collapse-chevron-icon" data-feather="chevron-down" width="25" class="text-gray"></i>
                    </div>
            ...
            <div class="collapse {{ (request()->is('panel/resources') or request()->is('panel/resources/*')) ? 'show' : '' }}" id="ResourceCollapse">
                <ul class="sidenav-item-collapse">
                        <li class="mt-5 {{ (request()->is('panel/resources/new')) ? 'active' : '' }}">
                            <a href="/panel/resources/daftar">{{ trans('public.list') }}</a>
                        </li>
                </ul>
            </div>
        </li>
        ...
        <li class="sidenav-item  accordion-row  {{ (request()->is('panel/meetings') or request()->is('panel/meetings/*')) ? 'sidenav-item-active' : '' }}">
        ...
        <li class="sidenav-item  accordion-row{{ (request()->is('panel/quizzes') or request()->is('panel/quizzes/*')) ? 'sidenav-item-active' : '' }}">
        ...
        <li class="sidenav-item accordion-row  {{ (request()->is('panel/certificates') or request()->is('panel/certificates/*')) ? 'sidenav-item-active' : '' }}">
        ...
        <li class="sidenav-item accordion-row {{ (request()->is('panel/financial') or request()->is('panel/financial/*')) ? 'sidenav-item-active' : '' }}">
        ...
        <li class="sidenav-item accordion-row  {{ (request()->is('panel/support') or request()->is('panel/support/*')) ? 'sidenav-item-active' : '' }}">
        ...
        @if(getFeaturesSettings('forums_status'))
            <li class="sidenav-item accordion-row  {{ (request()->is('panel/forums') or request()->is('panel/forums/*')) ? 'sidenav-item-active' : '' }}">
...
{{-- 
        <li class="sidenav-item">
            <a href="{{ getAdminPanelUrl() }}/logout" class="d-flex align-items-center">
