...
<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('update.access_days') }}<span class="font-12 text-grey"> ({{ trans('public.optional') }})</span></label>
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.price') }} ({{ $currency }})<span class="font-12 text-grey"> ({{ trans('public.optional') }})</span></label>
