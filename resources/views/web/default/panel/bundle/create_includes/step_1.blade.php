...
<div class="row">
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-25">
            <label class="input-label">{{ trans('public.demo_video') }} <span class="font-12 text-grey">({{ trans('public.optional') }})</span></label>
        ...
        <div class="form-group mt-0">
            <label class="input-label font-12">{{ trans('update.path') }} <span class="text-grey font-12">(Opsional)</span> </label>
