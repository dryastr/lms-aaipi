            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/36-charge.svg" width="64" height="64" alt="">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/37-payout.svg" width="64" height="64" alt="">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/38-income.svg" width="64" height="64" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 mb-25 mb-lg-0 js-offline-payment-input " style="{{ (!$showOfflineFields) ? 'display:none' : '' }}">
                        <div class="form-group">
                            ...
                            <input type="file" name="attachment" id="attachmentFile" class="form-control h-auto invisible-file-input @error('attachment') is-invalid @enderror" value="" placeholder="asu"/>
                            
                            <label for="attachmentFile" class="position-relative" style="font-size: 10px; top:-5px">{{ trans('public.img_must_jpg') }}</label>
                            
                            @if (!empty($editOfflinePayment) && !empty($editOfflinePayment->attachment))
                                <div class="font-12">
                                    File yang diunggah: <a class="" onclick="showModal(event)" style="text-decoration: underline">Lihat Foto</a>
                                </div>
                            @endif
                            @error('attachment')
                            ...
                            <div id="myModal" class="modal">
                                <span class="close-modal-bank" onclick="closeModal()">&times;</span>
                                <img class="modal-content modal-content-custom img-cover" id="img01">
                                <div id="caption"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="mt-40">
        ...
        <div class="row mt-25">
            <div class="col-md-12">
                <div class="d-flex">
                    @foreach($offlineBanks as $offlineBank)
                        <div class="col-lg-3 col-md-3 mb-30 mb-lg-0">
                            <div class="card-body-offline-bank rounded-sm panel-shadow d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="mt-15 mt-30 w-100">
                                    ...
                                    @foreach($offlineBank->specifications as $specification)
                                        <div class="d-flex justify-content-between mt-10">
                                            <span class="w-font-title-bank font-14 font-weight-500 text-secondary">{{ $specification->name }}:</span>
                                            <span class="w-font-value-bank font-14 font-weight-500 text-gray">{{ $specification->value }}</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
    ...
    <script>
        ...
        function showModal(event) {
            ...
            @if (!empty($editOfflinePayment) && !empty($editOfflinePayment->attachment))
                ...
                modalImg.src = "/store/3/offlinePayments/{{ $editOfflinePayment->attachment }}";
                captionText.innerHTML = "{{ $editOfflinePayment->attachment }}";
            @endif
