            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/online-courses.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/time.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/elearning.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/total-sale.svg" width="64" height="64" alt="">
                ...
                <div class="row mt-30">
                    <div class="col-12">
                        <div class="webinar-card webinar-list d-flex">
                            <div class="image-box image-box-custom">
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15" data-toggle="tooltip" title="{{ !empty($webinar->category_id) ? $webinar->category->title : '' }}">
                                        <span class="stat-title">{{ trans('public.category') }}:</span>
                                        <span class="stat-value" data-toggle="tooltip" title="{{ !empty($webinar->category_id) ? $webinar->category->title : '' }}">
                                            {{ !empty($webinar->category_id) ? Str::limit($webinar->category->title, 20) : '' }}
                                        </span>
                                    </div>
                                        ...
                                        @if($webinar->isWebinar())
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <span class="stat-value">
                                                    {{ \Carbon\Carbon::parse($nextSession->date)->locale('id')->translatedFormat('j F Y | H:i') }}    
                                                </span>
                                            </div>
                                        @endif
                                    @else
                                        ...
                                        @if($webinar->isWebinar())
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <span class="stat-value">
                                                    {{ \Carbon\Carbon::parse($webinar->start_date)->locale('id')->translatedFormat('j F Y') }}    
                                                </span>
                                            </div>
                                        @endif
                                    @endif
