...
{{--         
        <div id="additionalForm" class="form-group custom-switches-stacked">
            <label class="" for="partnerInstructorSwitch">{{ trans('public.live_ya') }}</label>
            <div class="custom-control custom-switch">
                <input type="checkbox" name="is_live_streaming" class="custom-control-input" id="is_live_streaming" {{ ((!empty($webinar) && $webinar->is_live_streaming) or old('is_live_streaming') == '1' ) ? 'checked' : ''  }}>
        ...
        {{-- <div id="additionalTable" class="form-group mt-15">
            <label class="input-label">{{ trans('public.url_live_zoom') }}</label>
