...
<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.price_member_aaipi') }} ({{ $currency }})</label>
            <input type="number" name="price" value="{{ (!empty($webinar) and !empty($webinar->price)) ? convertPriceToUserCurrency($webinar->price) : old('price') }}" class="form-control @error('price')  is-invalid @enderror" placeholder="{{ trans('public.0_for_free_membership') }}"/>
            @error('price')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group mt-15">
            <label class="input-label">{{ trans('public.harga_member_platform') }} ({{ $currency }})</label>
            <input type="number" name="price_guest" value="{{ (!empty($webinar) and !empty($webinar->price_guest)) ? convertPriceToUserCurrency($webinar->price_guest) : old('price_guest') }}" class="form-control @error('price_guest')  is-invalid @enderror" placeholder="{{ trans('public.0_for_free') }}"/>
            @error('price_guest')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
