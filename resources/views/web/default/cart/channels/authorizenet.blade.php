                                            ...
                                            <form id="payment-card-info" method="post" action="/payments/payment-request">
                                                ...
                                                <div class="row">
                                                    <div class="form-group owner col-md-8">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Cari" id="owner" name="owner" value="{{ old('owner') }}" required>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-8" id="card-number-field">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Cari" id="cardNumber" name="cardNumber" value="{{ old('cardNumber') }}" required>
