...
@section('content')
    <section class="cart-banner position-relative text-center">
        ...
        @if (!$user->is_member_aaipi)
        <span class="payment-hint font-20 text-white d-block"> {{ handlePriceGuest($subTotalPriceGuset) . ' ' . trans('cart.for_items',['count' => $carts->count()]) }}</span>
        @else
                    ...
                    <div class="row mt-5 cart-row">
                        ...
                        <div class="col-6 col-lg-2 d-flex flex-md-column align-items-center justify-content-center">
                            ...
                            @if(!empty($cartItemInfo['discountPrice']))
                                ...
                                @elseif(!$user->is_member_aaipi && isset($cartItemInfo['price_guest']))
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold">{{ handlePrice($cartItemInfo['price_guest'], true, true, false, null, true, $cartTaxType) }}</span>
                                @else
                    ...
                    <section class="mt-45">
                        ...
                        <div class="rounded-sm shadow mt-20 pb-20 px-20">
                            ...
                            <div class="cart-checkout-item">
                                ...
                                @if(!$user->is_member_aaipi)
                                <span class="font-14 text-gray font-weight-bold">{{ handlePriceGuest($subTotalPriceGuset) }}</span>
                                @else
                            ...
                            <div class="cart-checkout-item border-0">
                                ...
                                @if (!$user->is_member_aaipi)
                                <span class="font-14 text-gray font-weight-bold"><span id="totalAmount">{{ handlePriceGuest($totalPriceGuest) }}</span></span>
                                @else
