    ...
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="reviews-rate font-36 font-weight-bold text-primary mr-5">{{ $course->getRate() }}</div>
            ...
            <div class="mt-5 text-left">{{ $course->reviews->pluck('creator_id')->count() }}  {{ trans('product.reviews') }}</div>
        </div>

        <div class="col-9">
            <div class="d-flex align-items-center">
                <div class="progress course-progress rounded-sm" style="width: 60%; min-width: 60%;">
