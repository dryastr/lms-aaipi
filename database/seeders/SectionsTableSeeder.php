...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Admin Provinsi
        Section::updateOrCreate(['id' => 3039], ['name' => 'admin_provinsi', 'caption' => 'Provinsi']);
        Section::updateOrCreate(['id' => 3040], ['name' => 'admin_provinsi_list', 'section_group_id' => 3039, 'caption' => 'List']);
        Section::updateOrCreate(['id' => 3041], ['name' => 'admin_provinsi_create', 'section_group_id' => 3039, 'caption' => 'Create']);
        Section::updateOrCreate(['id' => 3071], ['name' => 'admin_provinsi_edit', 'section_group_id' => 3039, 'caption' => 'Admin Provinsi Edit']);
        Section::updateOrCreate(['id' => 3072], ['name' => 'admin_provinsi_delete', 'section_group_id' => 3039, 'caption' => 'Admin Provinsi Delete']);

        // Admin Kabupaten
        Section::updateOrCreate(['id' => 3042], ['name' => 'admin_kabupaten', 'caption' => 'Kabupaten']);
        Section::updateOrCreate(['id' => 3043], ['name' => 'admin_kabupaten_list', 'section_group_id' => 3042, 'caption' => 'List']);
        Section::updateOrCreate(['id' => 3044], ['name' => 'admin_kabupaten_create', 'section_group_id' => 3042, 'caption' => 'Create']);
        Section::updateOrCreate(['id' => 3073], ['name' => 'admin_kabupaten_edit', 'section_group_id' => 3042, 'caption' => 'Admin Kabupaten Edit']);
        Section::updateOrCreate(['id' => 3074], ['name' => 'admin_kabupaten_delete', 'section_group_id' => 3042, 'caption' => 'Admin Kabupaten Delete']);

        // Admin Thematic
        Section::updateOrCreate(['id' => 3047], ['name' => 'admin_thematic', 'caption' => 'Thematic']);
        Section::updateOrCreate(['id' => 3048], ['name' => 'admin_thematic_list', 'section_group_id' => 3047, 'caption' => 'Thematic Lists']);
        Section::updateOrCreate(['id' => 3049], ['name' => 'admin_thematic_create', 'section_group_id' => 3047, 'caption' => 'Admin Thematic Create']);
        Section::updateOrCreate(['id' => 3050], ['name' => 'admin_thematic_edit', 'section_group_id' => 3047, 'caption' => 'Admin Thematic Edit']);
        Section::updateOrCreate(['id' => 3051], ['name' => 'admin_thematic_delete', 'section_group_id' => 3047, 'caption' => 'Admin Thematic Delete']);

        // Admin Type
        Section::updateOrCreate(['id' => 3052], ['name' => 'admin_type', 'caption' => 'Admin Type']);
        Section::updateOrCreate(['id' => 3053], ['name' => 'admin_type_list', 'section_group_id' => 3052, 'caption' => 'Admin Type Lists']);
        Section::updateOrCreate(['id' => 3054], ['name' => 'admin_type_create', 'section_group_id' => 3052, 'caption' => 'Admin Type Create']);
        Section::updateOrCreate(['id' => 3055], ['name' => 'admin_type_edit', 'section_group_id' => 3052, 'caption' => 'Admin Type Edit']);
        Section::updateOrCreate(['id' => 3056], ['name' => 'admin_type_delete', 'section_group_id' => 3052, 'caption' => 'Admin Type Delete']);

        // Admin Cross Competency
        Section::updateOrCreate(['id' => 3057], ['name' => 'admin_cross_competency', 'caption' => 'Cross Competencies']);
        Section::updateOrCreate(['id' => 3058], ['name' => 'admin_cross_competency_list', 'section_group_id' => 3057, 'caption' => 'Cross Competencies Lists']);
        Section::updateOrCreate(['id' => 3059], ['name' => 'admin_cross_competency_edit', 'section_group_id' => 3057, 'caption' => 'Cross Competencies Edit']);
        Section::updateOrCreate(['id' => 3060], ['name' => 'admin_cross_competency_create', 'section_group_id' => 3057, 'caption' => 'Cross Competencies Create']);
        Section::updateOrCreate(['id' => 3061], ['name' => 'admin_cross_competency_delete', 'section_group_id' => 3057, 'caption' => 'Cross Competencies Delete']);

        // Admin Resources
        Section::updateOrCreate(['id' => 3062], ['name' => 'admin_resources', 'caption' => 'Admin Resources']);
        Section::updateOrCreate(['id' => 3063], ['name' => 'admin_resources_list', 'section_group_id' => 3062, 'caption' => 'Admin Resources Lists']);
        Section::updateOrCreate(['id' => 3064], ['name' => 'admin_resources_create', 'section_group_id' => 3062, 'caption' => 'Admin Resources Create']);
        Section::updateOrCreate(['id' => 3065], ['name' => 'admin_resources_edit', 'section_group_id' => 3062, 'caption' => 'Admin Resources Edit']);
        Section::updateOrCreate(['id' => 3066], ['name' => 'admin_resources_delete', 'section_group_id' => 3062, 'caption' => 'Admin Resources Delete']);

        // Admin Users
        Section::updateOrCreate(['id' => 3067], ['name' => 'admin_users_dpw', 'section_group_id' => 100, 'caption' => 'Admin Users DPW']);
        Section::updateOrCreate(['id' => 3068], ['name' => 'admin_user_anggota_luar_biasa', 'section_group_id' => 100, 'caption' => 'Admin Users Anggota Luar Biasa']);
        Section::updateOrCreate(['id' => 3069], ['name' => 'admin_users_anggota_kehormatan_list', 'section_group_id' => 100, 'caption' => 'Admin Users Anggota Kehormatan']);
        Section::updateOrCreate(['id' => 3070], ['name' => 'admin_users_anggota_biasa_list', 'section_group_id' => 100, 'caption' => 'Admin Users Anggota Biasa']);

        // Admin Term Condition
        Section::updateOrCreate(['id' => 3075], ['name' => 'admin_term_condition', 'caption' => 'Admin Term Condition']);
        Section::updateOrCreate(['id' => 3076], ['name' => 'admin_term_condition_create', 'section_group_id' => 3075, 'caption' => 'Admin Term Condition Create']);
        Section::updateOrCreate(['id' => 3077], ['name' => 'admin_term_condition_list', 'section_group_id' => 3075, 'caption' => 'Admin Term Condition List']);

        // Admin Iklan Banner
        Section::updateOrCreate(['id' => 3078], ['name' => 'admin_iklan_banner', 'caption' => 'Admin Iklan Banner']);
        Section::updateOrCreate(['id' => 3079], ['name' => 'admin_iklan_banner_list', 'section_group_id' => 3077, 'caption' => 'Admin Iklan Banner Lists']);
        Section::updateOrCreate(['id' => 3080], ['name' => 'admin_iklan_banner_create', 'section_group_id' => 3077, 'caption' => 'Admin Iklan Banner Create']);
        Section::updateOrCreate(['id' => 3081], ['name' => 'admin_iklan_banner_edit', 'section_group_id' => 3077, 'caption' => 'Admin Iklan Banner Edit']);
        Section::updateOrCreate(['id' => 3082], ['name' => 'admin_iklan_banner_delete', 'section_group_id' => 3077, 'caption' => 'Admin Iklan Banner Delete']);
